...
export default function Stats(props) {
    ...
    return (
        <div>
            ...
            <div className="cases">
                <h2><span className="title">New Cases:</span> {props.covidStats.cases.new === null ? "Nothing to show" : props.covidStats.cases.new.toLocaleString()}</h2>
                <h2><span className="title">New Deaths:</span> {props.covidStats.deaths.new === null ? "Nothing to show" : props.covidStats.deaths.new.toLocaleString()}</h2>
            </div>
            <div className="cases">
